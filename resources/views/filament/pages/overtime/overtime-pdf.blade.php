...
@endphp
    ...
    <table class="info-table">
        <tr>
            <td style="width: 50%;">
                <span>Nama &nbsp;: <strong>{{ $nama ?? '_______________________' }}</strong></span>
            </td>
            <td style="width: 50%;">
                <span>Bulan/Tahun (Month/Year) &nbsp;: <strong>{{ $bulan_tahun ?? '_______________' }}</strong></span>
            </td>
        </tr>
    </table>
...
<table class="main-table">
    <thead>
        <tr>
            ...
            <th colspan="2" class="th-group">
                Jam Kerja<br><em>Working Hours</em>
            </th>

            <th colspan="2" class="th-group">
                Lembur<br><em>Overtime</em>
            </th>

            <th rowspan="2" style="width: 55px;">
                Uang Makan<br><em>Meal Allow.</em>
            </th>

            <th rowspan="2">
                Uraian Pekerjaan<br><em>Job Description</em>
            </th>

            <th rowspan="2" style="width: 55px;">
                Jumlah Jam Lembur<br><em>Total OT Hours</em>
            </th>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            <td>
                {{ \Carbon\Carbon::parse($row->tanggal_lembur)->format('d/m/Y') }}
            </td>
        ...
        @empty
        <tr>
            <td colspan="{{ $showEmployeeCol ? 9 : 8 }}" style="height:25px;"></td>
        </tr>
        @endforelse

        <tr class="total-row">
            <td colspan="{{ $showEmployeeCol ? 8 : 7 }}" style="text-align:right; padding-right:10px;">
